        ...
        <main className="flex-1 overflow-y-auto p-4 sm:p-10">
          <div className="max-w-3xl mx-auto space-y-8 sm:space-y-12">
            ...
            <div className="space-y-10">
              <h2 className="text-2xl sm:text-4xl font-extrabold text-slate-950 leading-[1.3] tracking-tight">
                ...
                {currentQuestion.options.map((option, idx) => {
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        "w-full text-left p-5 sm:p-6 rounded-2xl border-2 transition-all flex items-center gap-5 group premium-shadow",
                        showResult
                          ? isCorrect 
            ...
            <div className="flex justify-between pt-10 sm:pt-16 pb-12">
              <button 
                disabled={currentQuestionIndex === 0}
                onClick={prevQuestion}
                className="flex items-center gap-3 px-6 py-4 rounded-2xl border-2 border-slate-200 font-extrabold text-slate-600 hover:bg-white hover:border-brand-400 hover:text-brand-600 disabled:opacity-30 transition-all text-base sm:text-lg active:scale-95"
              >
              ...
              <button 
                ...
                className="flex items-center gap-3 px-8 py-4 rounded-2xl bg-slate-950 text-white font-extrabold hover:bg-slate-800 disabled:opacity-30 transition-all text-base sm:text-lg active:scale-95 premium-shadow"
              >
