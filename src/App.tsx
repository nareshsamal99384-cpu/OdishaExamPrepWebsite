  ...
  return (
    <div className="space-y-6">
      <div className="border-b border-slate-100 pb-4 space-y-3">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3.5 sm:gap-4">
          <div className="flex items-start sm:items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[10px] sm:text-xs font-semibold text-slate-400 mt-1 sm:hidden">
          ...
          {activities.length > 0 && (
            <div className="shrink-0 pl-[52px] sm:pl-0 self-start sm:self-auto">
              {confirmClearAll ? (
        ...
        <p className="text-[10px] sm:text-xs font-semibold text-slate-400 pl-[52px] hidden sm:block">
          Manage and track your exam mock tests and practice sessions
        </p>
      </div>
